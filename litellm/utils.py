    ...
    try:
        ...
        if custom_llm_provider == "huggingface":
            ...
            returned_model_info = ModelInfoBase(
                ...
                output_cost_per_second_hd=_model_info.get("output_cost_per_second_hd", None),
                output_cost_per_second_fhd=_model_info.get("output_cost_per_second_fhd", None),
                output_cost_per_second_v2v=_model_info.get("output_cost_per_second_v2v", None),
                output_cost_per_second_v2v_hd=_model_info.get("output_cost_per_second_v2v_hd", None),
                output_cost_per_second_v2v_fhd=_model_info.get("output_cost_per_second_v2v_fhd", None),
