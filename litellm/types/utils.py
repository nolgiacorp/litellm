...
class ModelInfoBase(ProviderSpecificModelInfo, total=False):
    ...
    output_cost_per_second_720p: float | None
    output_cost_per_second_hd: float | None  # video_generation tiers for BFL flux-3-video (NOL-535)
    output_cost_per_second_fhd: float | None
    output_cost_per_second_v2v: float | None
    output_cost_per_second_v2v_hd: float | None
    output_cost_per_second_v2v_fhd: float | None
    output_cost_per_credit: float | None  # for models billed in provider credits (e.g. Topaz video)
    output_cost_per_audio: float | None  # flat per-request audio generation
...
class CustomPricingLiteLLMParams(MirroredPricingParams):
    ...
    output_cost_per_second_hd: float | None = None
    output_cost_per_second_fhd: float | None = None
    output_cost_per_second_v2v: float | None = None
    output_cost_per_second_v2v_hd: float | None = None
    output_cost_per_second_v2v_fhd: float | None = None
    output_cost_per_credit: float | None = None
    output_cost_per_audio: float | None = None
